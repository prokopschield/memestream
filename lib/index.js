...
nodesite_eu_1.default.create(domain, '/', () => ({ statusCode: 302, head: { Location: '/src/index.html' } }), '.');
nodesite_eu_1.default.create(domain, '/post', (request) => {
    var _a, _b;
...
nodesite_eu_1.default.create(domain, '/last', () => {
    return ({
        body: `${memecount}`,
    });
});
nodesite_eu_1.default.create(domain, '/get', (request) => {
